# Rapo v0.6.8 Migration Instructions
This short document describes how to upgrade Rapo from v0.5.1 to v0.6.8:
...
1. Backup your control configurations.
    ...
    ```
1. Perform module upgdate `pip install --upgrade rapo==0.6.8`.
